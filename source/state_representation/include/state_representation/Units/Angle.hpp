#ifndef STATEREPRESENTATION_UNITS_ANGLE_H_
#define STATEREPRESENTATION_UNITS_ANGLE_H_
...
namespace state_representation
{
	namespace Units
	{
		...
		inline namespace literals
		{
			 ...
			 * @param n the rhsle value in radian
			 ...
			 * @param n the rhsle value in degree
			 * @param the Angle in the base unit (radian)
			 */
		...
		{
		private:
			long double value; ///< value of the rhsle in radian (base unit)
