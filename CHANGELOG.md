...
- fix: remove the non defined operators that were cause linking issues (#108)
...
- Delete inaccessible getters and setters (#102)
- Delete joint derivatives inaccessible getters and setters (#103)
