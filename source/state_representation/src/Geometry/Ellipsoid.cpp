...
namespace StateRepresentation
{
	...
	const Ellipsoid Ellipsoid::from_algebraic_equation(const std::string& name, const std::vector<double>& coefficients, const std::string& reference_frame)
	{
	...
	const Ellipsoid Ellipsoid::fit(const std::string& name, const std::list<CartesianPose>& points, const std::string& reference_frame, double noise_level)
	{
